...
# Imprimir estadísticas para T_h
for variable in Variables_T_h:
    print(f"\nEstación: {num_estacion} - Variable: {variable}")
    print("{:<10} {:<10} {:<10} {:<10} {:<10}".format("Mes", "Máximo", "Mínimo", "Media", "Desviación Estándar"))
    for mes in range(1, 13):
        ...
        print("{:<10} {:<10} {:<10} {:<10} {:<10}".format(nombres_meses[mes - 1], Max_T_h, Min_T_h, Media_T_h, Desvest_T_h))
...
# Imprimir estadísticas para T_d
for variable in Variables_T_d:
    print(f"\nEstación: {num_estacion} - Variable: {variable}")
    print("{:<10} {:<10} {:<10} {:<10} {:<10}".format("Mes", "Máximo", "Mínimo", "Media", "Desviación Estándar"))
    for mes in range(1, 13):
        ...
        print("{:<10} {:<10} {:<10} {:<10} {:<10}".format(nombres_meses[mes - 1], Max_T_d, Min_T_d, Media_T_d, Desvest_T_d))
